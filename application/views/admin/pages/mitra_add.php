      ...
      <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="alamat" id="alamat" rows="10" style="min-height: 300px"></textarea>
          </div>
      ...
      <div class="card card-default">
        ...
        <div class="card-body">
          <div class="form-group d-flex align-items-end">
            <img src="<?php echo asset_url('images/mitra/default.png') ?>" alt="Photo" class="img-thumbnail mr-3 w-50" id="photo-preview">
