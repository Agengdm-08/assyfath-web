   ...
   <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
     ...
     <div class="carousel-item active">
       <div class="carousel-container">
         <img class="animate__animated animate__fadeInDown" src="<?php echo asset_url('frontend/') ?>img/home-slider/slide-1.jpg" />
     ...
     <div class="carousel-item">
       <div class="carousel-container">
         <img class="animate__animated animate__fadeInDown" src="<?php echo asset_url('frontend/') ?>img/home-slider/slide-2.jpg" />
         <p class="animate__animated animate__fadeInUp">
           Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et
           est quaerat sequi nihil ut aliquam. Occaecati alias dolorem
           mollitia ut. Similique ea voluptatem. Esse doloremque accusamus
         ...
         <a href="produk-detail-two.html" class="btn-get-started animate__animated animate__fadeInUp">Detail</a>
       </div>
     </div>
     ...
     <div class="carousel-item">
       <div class="carousel-container">
         <img class="animate__animated animate__fadeInDown" src="<?php echo asset_url('frontend/') ?>img/home-slider/slide-3.jpg" />
         <p class="animate__animated animate__fadeInUp">
           Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et
           est quaerat sequi nihil ut aliquam. Occaecati alias dolorem
           mollitia ut. Similique ea voluptatem. Esse doloremque accusamus
         ...
         <a href="produk-detail-three.html" class="btn-get-started animate__animated animate__fadeInUp">Detail</a>
       </div>
     </div>
     ...
     <div class="container">
       <div class="row">
         <div class="col-lg-6 video-box">
           <img src="<?php echo asset_url('frontend/') ?>img/why-us.jpg" class="img-fluid" alt="" />
   ...
   <section class="features">
     <div class="container">
       ...
       <div class="row" data-aos="fade-up">
         <div class="col-md-5">
           <img src="<?php echo asset_url('frontend/') ?>img/features-1.svg" class="img-fluid" alt="" />
         </div>
         <div class="col-md-7 pt-4">
           ...
           <ul>
             ...
             <li>
               <i class="icofont-check"></i> Duis aute irure dolor in
       ...
       <div class="row" data-aos="fade-up">
         <div class="col-md-5 order-1 order-md-2">
           <img src="<?php echo asset_url('frontend/') ?>img/features-2.svg" class="img-fluid" alt="" />
         </div>
       ...
       <div class="row" data-aos="fade-up">
         <div class="col-md-5">
           <img src="<?php echo asset_url('frontend/') ?>img/features-3.svg" class="img-fluid" alt="" />
         </div>
         <div class="col-md-7 pt-5">
           ...
           <ul>
             ...
             <li>
               <i class="icofont-check"></i> Facilis ut et voluptatem
       ...
       <div class="row" data-aos="fade-up">
         <div class="col-md-5 order-1 order-md-2">
           <img src="<?php echo asset_url('frontend/') ?>img/features-4.svg" class="img-fluid" alt="" />
         </div>
         <div class="col-md-7 pt-5 order-2 order-md-1">
           <h3>
     ...
     <div class="container">
       <div class="row">
         <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
           <div class="member">
             <div class="member-img">
               <img src="<?php echo asset_url('frontend/') ?>img/team/team-1.jpg" class="img-fluid" alt="" />
               <div class="social">
         ...
         <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
           <div class="member">
             <div class="member-img">
               <img src="<?php echo asset_url('frontend/') ?>img/team/team-2.jpg" class="img-fluid" alt="" />
               <div class="social">
                 <a href=""><i class="icofont-twitter"></i></a>
                 <a href=""><i class="icofont-facebook"></i></a>
                 <a href=""><i class="icofont-instagram"></i></a>
         ...
         <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
           <div class="member">
             <div class="member-img">
               <img src="<?php echo asset_url('frontend/') ?>img/team/team-3.jpg" class="img-fluid" alt="" />
               <div class="social">
                 <a href=""><i class="icofont-twitter"></i></a>
                 <a href=""><i class="icofont-facebook"></i></a>
                 <a href=""><i class="icofont-instagram"></i></a>
         ...
         <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
           <div class="member">
             <div class="member-img">
               <img src="<?php echo asset_url('frontend/') ?>img/team/team-4.jpg" class="img-fluid" alt="" />
               <div class="social">
                 <a href=""><i class="icofont-twitter"></i></a>
                 <a href=""><i class="icofont-facebook"></i></a>
                 <a href=""><i class="icofont-instagram"></i></a>
         ...
         <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
           <div class="member">
             <div class="member-img">
               <img src="<?php echo asset_url('frontend/') ?>img/team/team-5.jpg" class="img-fluid" alt="" />
               <div class="social">
                 <a href=""><i class="icofont-twitter"></i></a>
                 <a href=""><i class="icofont-facebook"></i></a>
                 <a href=""><i class="icofont-instagram"></i></a>
         ...
         <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
           <div class="member">
             <div class="member-img">
               <img src="<?php echo asset_url('frontend/') ?>img/team/team-6.jpg" class="img-fluid" alt="" />
               <div class="social">
                 <a href=""><i class="icofont-twitter"></i></a>
                 <a href=""><i class="icofont-facebook"></i></a>
                 <a href=""><i class="icofont-instagram"></i></a>
